...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center"x>
            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/login') }}" method="post">@csrf
                    <div class="input-group mb-3">
                        <input name="email" type="text" class="form-control" placeholder="Email" @if(isset($_COOKIE["email"])) value="{{ $_COOKIE["email"] }}" @endif required>
    ...
    <!-- AdminLTE App -->
    <script src="{{ url('admin/plugins/js/adminlte.min.js') }}"></script>
</body>
