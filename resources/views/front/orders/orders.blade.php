                                            ...
                                            <div class="manage-o__header u-s-m-b-30">
                                                <div class="dash-l-r">
                                                    <div>
                                                        ...
                                                        <div class="manage-o__text u-c-silver">Placed on {{ date("j F,Y , g:i a",strtotime($order->created_at)) }}</div>
                                                    </div>
                                                    <div>
                                                ...
                                                <div class="description__info-wrap">
                                                    ...
                                                    <div>
                                                            <span class="manage-o__text-2 u-c-silver">Grand Total:
                                                                ...
                                                                <span class="manage-o__text-2 u-c-secondary">Rp.{{ $order->grand_total }}</span></span></div>
                                                    </div>
                                                </div>
                                        </div>
                                        @endforeach
