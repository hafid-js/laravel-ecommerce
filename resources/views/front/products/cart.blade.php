                                ...
                                <table class="table-p">
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <div class="table-p__box">
                                                    ...
                                                    <div class="table-p__info">
                                                        ...
                                                        <span class="table-p__category">
                                                            <a href="shop-side-version-2.html">Brand: {{ $item['product']['brand']['brand_name'] }}</a></span>
                                            ...
                                            <td>
                                                <span class="table-p__price">Rp.{{ $item['product']['final_price']*$item['product_qty']}}</span></td>
                                            <td>
