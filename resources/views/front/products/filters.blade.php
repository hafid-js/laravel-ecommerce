                        ...
                        <li class="has-list">
                            ...
                            <ul style="display:block">
                                ...
                                <li class="has-list">
                                    ...
                                    <a @if(isset($categoryDetails['categoryDetails']['parentcategory']['category_name']) && $categoryDetails['categoryDetails']['parentcategory']['category_name'] == $subcategory['category_name']) style="color:#FF4500" @elseif(isset($categoryDetails['categoryDetails']['parentcategory']['category_name']) && $categoryDetails['categoryDetails']['category_name'] == $subcategory['category_name']) style="color:#FF4500" @endif href="{{ url($subcategory['url']) }}">{{ $subcategory['category_name'] }} </a>
                            ...
                            <li>
                                ...
                                <div class="check-box">
                                    <input type="checkbox" id="size{{ $key }}" name="size"
                                        value="{{ $size }}" class="filterAjax" {{ $sizechecked }}>
                            ...
                            <li>
                                ...
                                <div class="check-box">
                                    <input type="checkbox" id="brand{{ $key }}" name="brand"
                                        value="{{ $brand['id'] }}" class="filterAjax" {{ $brandchecked }}>
                                    <div class="check-box__state check-box__state--primary">
                                        <label class="check-box__label"
        ...
        <div class="u-s-m-b-30">
            <div class="shop-w shop-w--style">
                ...
                <div class="shop-w__wrap collapse show" id="s-price">
                    <?php $getPrices = ['0-1000', '1001-2000', '2001-5000', '5001-10000', '10001-300000']; ?>
                    <ul class="shop-w__list gl-scroll">
                            ...
                            <li>
                                ...
                                <div class="check-box">
                                    <input type="checkbox" id="price{{ $key }}" name="price"
                                        value="{{ $price }}" class="filterAjax" {{ $pricechecked }}>
                                    <div class="check-box__state check-box__state--primary">
                                        <label class="check-box__label"
                            ...
                            <li>
                                <div class="color__check">
                                    <input type="checkbox" id="color{{ $key }}" name="color"
                                        value="{{ $color }}" class="filterAjax" {{ $colorchecked }}>
                ...
                <div class="shop-w shop-w--style">
                    <div class="shop-w__intro-wrap">
                        ...
                        <span class="fas fa-minus shop-w__toggle"
                            data-target="#s-filter{{ $key }}" data-toggle="collapse"></span>
                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="check-box">
                                        ...
                                        <div class="check-box__state check-box__state--primary">
                                            ...
                                            <label class="check-box__label"
                                                for="filter{{ $fkey }}">{{ $filterValue }}</label>
                                        </div>
                                    </div>
                                    <!--====== End - Check Box ======-->
                                </li>
